...
function ContactForm() {
  ...
  function onSubmit() {
    ...
    import_mail.default.send(msg).then((res) => console.log(res)).catch((e) => console.log(e));
  }
...
var import_mail2 = __toModule(require("@sendgrid/mail"));
var msg2 = {
  to: "andrewangelle@gmail.com",
  from: "andrewangelle.com",
  subject: "Sending with SendGrid is Fun",
...
async function action({ request }) {
  import_mail2.default.setApiKey(process.env.SEND_GRID_API_KEY);
  await import_mail2.default.send(msg2);
